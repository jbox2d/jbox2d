...
/**
 * Called when an object is unsupported by the serializer or
 * deserializer.  Pertains to shapes, joints and 
 * other objects that might not be in some versions of the engine.
