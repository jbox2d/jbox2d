...
BoxWrap2d requires Java 1.5 to run, which means that a recent (roughly June 2008 or later) version of Processing is necessary.  If you absolutely need 1.4 support, you can use Retroweaver to weave 1.4 compatible bytecode, but in most cases this should be unnecessary.