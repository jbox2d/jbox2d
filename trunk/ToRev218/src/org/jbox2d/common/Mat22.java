...
public class Mat22 {
	...
	public final void set( final float col1x, final float col2x, final float col1y,
							final float col2y) {
		col1.x = col1x;
		col1.y = col1y;
		col2.x = col2x;
	...
	public final Mat22 abs() {
		return new Mat22( Math.abs( col1.x), Math.abs( col2.x), Math.abs( col1.y),
							Math.abs( col2.y));
	}
	...
	public final Mat22 mul( final Mat22 R) {
		/*
		 * Mat22 C = new Mat22();C.set(this.mul(R.col1), this.mul(R.col2));
		 * return C;
		 */
	...
	public final void mulToOut( final Mat22 R, final Mat22 out) {
		final float tempy = col1.y * R.col1.x + col2.y * R.col1.y;
		out.col1.x = col1.x * R.col1.x + col2.x * R.col1.y;
		out.col1.y = tempy;
		final float tempy1 = col1.y * R.col2.x + col2.y * R.col2.y;
		out.col2.x = col1.x * R.col2.x + col2.x * R.col2.y;
		out.col2.y = tempy1;
	}
	...
	public final Mat22 mulTrans( final Mat22 B) {
		...
		C.col1.x = Vec2.dot( col1, B.col1);
		C.col1.y = Vec2.dot( col2, B.col1);

		C.col2.x = Vec2.dot( col1, B.col2);
		C.col2.y = Vec2.dot( col2, B.col2);
		return C;
	}
	...
	public final void mulTransToOut( final Mat22 B, final Mat22 out) {
		 ...
		 * Vec2.dot(this.col2, B.col1); out.col2.x = Vec2.dot(this.col1,
		 * B.col2); out.col2.y = Vec2.dot(this.col2, B.col2);
		 */
		out.col1.x = col1.x * B.col1.x + col1.y * B.col1.y;
		out.col1.y = col2.x * B.col1.x + col2.y * B.col1.y;
		out.col2.x = col1.x * B.col2.x + col1.y * B.col2.y;
		out.col2.y = col2.x * B.col2.x + col2.y * B.col2.y;
	}
